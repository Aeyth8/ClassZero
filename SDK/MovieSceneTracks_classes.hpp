...
static_assert(sizeof(UMovieSceneCinematicShotSection) == 0x000188, "Wrong size on UMovieSceneCinematicShotSection");
static_assert(offsetof(UMovieSceneCinematicShotSection, ShotDisplayName) == 0x000160, "Member 'UMovieSceneCinematicShotSection::ShotDisplayName' has a wrong offset!");
static_assert(offsetof(UMovieSceneCinematicShotSection, DisplayName) == 0x000170, "Member 'UMovieSceneCinematicShotSection::DisplayName' has a wrong offset!");
