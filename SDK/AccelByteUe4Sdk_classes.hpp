...
public:
	...
	float                                         QosPingTimeout;                                    // 0x01C0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableHttpCache;                                  // 0x01C4(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAccelByteSettings) == 0x0001C8, "Wrong size on UAccelByteSettings");
...
static_assert(offsetof(UAccelByteSettings, QosPingTimeout) == 0x0001C0, "Member 'UAccelByteSettings::QosPingTimeout' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, bEnableHttpCache) == 0x0001C4, "Member 'UAccelByteSettings::bEnableHttpCache' has a wrong offset!");
...
static_assert(sizeof(UAccelByteSettingsCert) == 0x0001C8, "Wrong size on UAccelByteSettingsCert");
...
public:
	...
	float                                         QosPingTimeout;                                    // 0x0150(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAccelByteServerSettings) == 0x000158, "Wrong size on UAccelByteServerSettings");
...
static_assert(offsetof(UAccelByteServerSettings, QosPingTimeout) == 0x000150, "Member 'UAccelByteServerSettings::QosPingTimeout' has a wrong offset!");
...
static_assert(sizeof(UAccelByteServerSettingsDev) == 0x000158, "Wrong size on UAccelByteServerSettingsDev");
...
public:
	...
	void DeleteMemberRole(const class FString& MemberRoleId, const struct FAccelByteModelsUserIdWrapper& RequestContent, const TDelegate<void(struct FAccelByteModelsGetUserGroupInfoResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	...
	void UpdateGroup(const class FString& GroupID, const bool bCompletelyReplace, const struct FAccelByteModelsGroupUpdatable& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void UpdateGroupCustomAttributes(const class FString& GroupID, const struct FAccelByteModelsUpdateGroupCustomAttributesRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void UpdateGroupCustomRule(const class FString& GroupID, const struct FAccelByteModelsUpdateCustomRulesRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
...
public:
	...
	void GetAllUserStatItems(const TDelegate<void(const struct FAccelByteModelsUserStatItemPagingSlicedResult& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetUserStatItems(const TArray<class FString>& StatCodes, const TArray<class FString>& Tags, const TDelegate<void(const struct FAccelByteModelsUserStatItemPagingSlicedResult& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
...
public:
	...
	static void QueryAchievements(const class FString& Language, const EAccelByteAchievementListSortBy& SortBy, const TDelegate<void(struct FAccelByteModelsPaginatedPublicAchievement& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, const int32& Offset, const int32& Limit);
	static void QueryUserAchievements(const EAccelByteAchievementListSortBy& SortBy, const TDelegate<void(struct FAccelByteModelsPaginatedUserAchievement& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, const int32& Offset, const int32& Limit);
...
static_assert(sizeof(UABApiClient) == 0x000110, "Wrong size on UABApiClient");
...
static_assert(sizeof(UAccelByteServerSettingsCert) == 0x000158, "Wrong size on UAccelByteServerSettingsCert");
...
static_assert(sizeof(UAccelByteServerSettingsProd) == 0x000158, "Wrong size on UAccelByteServerSettingsProd");
...
static_assert(sizeof(UAccelByteSettingsDev) == 0x0001C8, "Wrong size on UAccelByteSettingsDev");
...
static_assert(sizeof(UAccelByteSettingsProd) == 0x0001C8, "Wrong size on UAccelByteSettingsProd");
