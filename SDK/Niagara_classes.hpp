...
static_assert(sizeof(UNiagaraDataInterfaceLandscape) == 0x000040, "Wrong size on UNiagaraDataInterfaceLandscape");
...
static_assert(sizeof(UNiagaraDataInterface2DArrayTexture) == 0x000040, "Wrong size on UNiagaraDataInterface2DArrayTexture");
...
public:
	...
	uint8                                         bAutoManageAttachment : 1;                         // 0x0544(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAutoAttachWeldSimulatedBodies : 1;                // 0x0544(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	FMulticastInlineDelegateProperty_             OnSystemFinished;                                  // 0x0568(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_58B[0x65];                                     // 0x058B(0x0065)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraComponent) == 0x0005F0, "Wrong size on UNiagaraComponent");
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000440, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x000448, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000450, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x000548, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, EmitterMaterials) == 0x000550, "Member 'UNiagaraComponent::EmitterMaterials' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x000568, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x000578, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x000580, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x000588, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x000589, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x00058A, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5E[0x22];                                      // 0x005E(0x0022)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UNiagaraRendererProperties, bIsEnabled) == 0x00005C, "Member 'UNiagaraRendererProperties::bIsEnabled' has a wrong offset!");
static_assert(offsetof(UNiagaraRendererProperties, bMotionBlurEnabled) == 0x00005D, "Member 'UNiagaraRendererProperties::bMotionBlurEnabled' has a wrong offset!");
...
static_assert(sizeof(UNiagaraComponentRendererProperties) == 0x000160, "Wrong size on UNiagaraComponentRendererProperties");
...
static_assert(offsetof(UNiagaraComponentRendererProperties, bAssignComponentsOnParticleID) == 0x0000E8, "Member 'UNiagaraComponentRendererProperties::bAssignComponentsOnParticleID' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, bOnlyCreateComponentsOnParticleSpawn) == 0x0000E9, "Member 'UNiagaraComponentRendererProperties::bOnlyCreateComponentsOnParticleSpawn' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, TemplateComponent) == 0x0000F0, "Member 'UNiagaraComponentRendererProperties::TemplateComponent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, PropertyBindings) == 0x0000F8, "Member 'UNiagaraComponentRendererProperties::PropertyBindings' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceGrid3DCollection, BufferFormat) == 0x000128, "Member 'UNiagaraDataInterfaceGrid3DCollection::BufferFormat' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceRenderTarget2D) == 0x000158, "Wrong size on UNiagaraDataInterfaceRenderTarget2D");
...
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2D, OverrideRenderTargetFormat) == 0x0000E0, "Member 'UNiagaraDataInterfaceRenderTarget2D::OverrideRenderTargetFormat' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceRenderTarget2D, ManagedRenderTargets) == 0x000108, "Member 'UNiagaraDataInterfaceRenderTarget2D::ManagedRenderTargets' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, bRequireCurrentFrameData) == 0x0000B9, "Member 'UNiagaraDataInterfaceSkeletalMesh::bRequireCurrentFrameData' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceVolumeTexture) == 0x000040, "Wrong size on UNiagaraDataInterfaceVolumeTexture");
...
static_assert(sizeof(UNiagaraEffectType) == 0x000110, "Wrong size on UNiagaraEffectType");
...
static_assert(offsetof(UNiagaraLightRendererProperties, ColorAdd) == 0x000088, "Member 'UNiagaraLightRendererProperties::ColorAdd' has a wrong offset!");
...
static_assert(sizeof(UNiagaraMeshRendererProperties) == 0x000678, "Wrong size on UNiagaraMeshRendererProperties");
static_assert(offsetof(UNiagaraMeshRendererProperties, ParticleMesh) == 0x000080, "Member 'UNiagaraMeshRendererProperties::ParticleMesh' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SortMode) == 0x000088, "Member 'UNiagaraMeshRendererProperties::SortMode' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, FacingMode) == 0x0000AC, "Member 'UNiagaraMeshRendererProperties::FacingMode' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxis) == 0x0000B4, "Member 'UNiagaraMeshRendererProperties::LockedAxis' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxisSpace) == 0x0000C0, "Member 'UNiagaraMeshRendererProperties::LockedAxisSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffset) == 0x0000C4, "Member 'UNiagaraMeshRendererProperties::PivotOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffsetSpace) == 0x0000D0, "Member 'UNiagaraMeshRendererProperties::PivotOffsetSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MinCameraDistance) == 0x0000D8, "Member 'UNiagaraMeshRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaxCameraDistance) == 0x0000DC, "Member 'UNiagaraMeshRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibility) == 0x0000E0, "Member 'UNiagaraMeshRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PositionBinding) == 0x0000E8, "Member 'UNiagaraMeshRendererProperties::PositionBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, VelocityBinding) == 0x000198, "Member 'UNiagaraMeshRendererProperties::VelocityBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, ScaleBinding) == 0x000248, "Member 'UNiagaraMeshRendererProperties::ScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageIndexBinding) == 0x0002A0, "Member 'UNiagaraMeshRendererProperties::SubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterialBinding) == 0x0002F8, "Member 'UNiagaraMeshRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial1Binding) == 0x000350, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial2Binding) == 0x0003A8, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial3Binding) == 0x000400, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialRandomBinding) == 0x000458, "Member 'UNiagaraMeshRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CustomSortingBinding) == 0x0004B0, "Member 'UNiagaraMeshRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, NormalizedAgeBinding) == 0x000508, "Member 'UNiagaraMeshRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CameraOffsetBinding) == 0x000560, "Member 'UNiagaraMeshRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibilityTagBinding) == 0x0005B8, "Member 'UNiagaraMeshRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
...
static_assert(sizeof(UNiagaraParameterCollectionInstance) == 0x0000C0, "Wrong size on UNiagaraParameterCollectionInstance");
...
public:
	...
	uint8                                         Pad_740[0x98];                                     // 0x0740(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraRibbonRendererProperties) == 0x0007D8, "Wrong size on UNiagaraRibbonRendererProperties");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, CurveTension) == 0x0000F8, "Member 'UNiagaraRibbonRendererProperties::CurveTension' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationMode) == 0x0000FC, "Member 'UNiagaraRibbonRendererProperties::TessellationMode' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationFactor) == 0x000100, "Member 'UNiagaraRibbonRendererProperties::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseConstantFactor) == 0x000104, "Member 'UNiagaraRibbonRendererProperties::bUseConstantFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationAngle) == 0x000108, "Member 'UNiagaraRibbonRendererProperties::TessellationAngle' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bScreenSpaceTessellation) == 0x00010C, "Member 'UNiagaraRibbonRendererProperties::bScreenSpaceTessellation' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PositionBinding) == 0x000110, "Member 'UNiagaraRibbonRendererProperties::PositionBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonTwistBinding) == 0x000270, "Member 'UNiagaraRibbonRendererProperties::RibbonTwistBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonIdBinding) == 0x000378, "Member 'UNiagaraRibbonRendererProperties::RibbonIdBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonLinkOrderBinding) == 0x0003D0, "Member 'UNiagaraRibbonRendererProperties::RibbonLinkOrderBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialRandomBinding) == 0x000428, "Member 'UNiagaraRibbonRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterialBinding) == 0x000480, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial1Binding) == 0x0004D8, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial2Binding) == 0x000530, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial3Binding) == 0x000588, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U0OverrideBinding) == 0x0005E0, "Member 'UNiagaraRibbonRendererProperties::U0OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V0RangeOverrideBinding) == 0x000638, "Member 'UNiagaraRibbonRendererProperties::V0RangeOverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, U1OverrideBinding) == 0x000690, "Member 'UNiagaraRibbonRendererProperties::U1OverrideBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, V1RangeOverrideBinding) == 0x0006E8, "Member 'UNiagaraRibbonRendererProperties::V1RangeOverrideBinding' has a wrong offset!");
...
static_assert(sizeof(UNiagaraScript) == 0x0002C0, "Wrong size on UNiagaraScript");
...
static_assert(offsetof(UNiagaraScript, CachedParameterCollectionReferences) == 0x000298, "Member 'UNiagaraScript::CachedParameterCollectionReferences' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedDefaultDataInterfaces) == 0x0002A8, "Member 'UNiagaraScript::CachedDefaultDataInterfaces' has a wrong offset!");
...
static_assert(sizeof(UNiagaraSettings) == 0x0000C0, "Wrong size on UNiagaraSettings");
...
static_assert(offsetof(UNiagaraSettings, DefaultEffectTypePtr) == 0x0000B8, "Member 'UNiagaraSettings::DefaultEffectTypePtr' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_728[0x78];                                     // 0x0728(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraSpriteRendererProperties) == 0x0007A0, "Wrong size on UNiagaraSpriteRendererProperties");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialRandomBinding) == 0x0005B8, "Member 'UNiagaraSpriteRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CustomSortingBinding) == 0x000610, "Member 'UNiagaraSpriteRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, NormalizedAgeBinding) == 0x000668, "Member 'UNiagaraSpriteRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibilityTagBinding) == 0x0006C0, "Member 'UNiagaraSpriteRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialParameterBindings) == 0x000718, "Member 'UNiagaraSpriteRendererProperties::MaterialParameterBindings' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3C8[0xB8];                                     // 0x03C8(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraSystem) == 0x000480, "Wrong size on UNiagaraSystem");
