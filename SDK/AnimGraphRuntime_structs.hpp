...
public:
	...
	uint8                                         Pad_208[0x448];                                    // 0x0208(0x0448)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody) == 0x000010, "Wrong alignment on FAnimNode_RigidBody");
static_assert(sizeof(FAnimNode_RigidBody) == 0x000650, "Wrong size on FAnimNode_RigidBody");
...
{
public:
	uint8                                         Pad_760[0x2A0];                                    // 0x0760(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000A00, "Wrong size on FAnimSequencerInstanceProxy");
