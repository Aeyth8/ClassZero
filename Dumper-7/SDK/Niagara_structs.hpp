...
static_assert(sizeof(FNiagaraComponentPropertyBinding) == 0x0000A0, "Wrong size on FNiagaraComponentPropertyBinding");
...
static_assert(offsetof(FNiagaraComponentPropertyBinding, WritableValue) == 0x000078, "Member 'FNiagaraComponentPropertyBinding::WritableValue' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVMExecutableData) == 0x0000E0, "Wrong size on FNiagaraVMExecutableData");
...
static_assert(sizeof(FNiagaraVariableMetaData) == 0x0000F0, "Wrong size on FNiagaraVariableMetaData");
...
static_assert(offsetof(FNiagaraVariableMetaData, ScopeName) == 0x0000C8, "Member 'FNiagaraVariableMetaData::ScopeName' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, Usage) == 0x0000D0, "Member 'FNiagaraVariableMetaData::Usage' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bIsStaticSwitch) == 0x0000D4, "Member 'FNiagaraVariableMetaData::bIsStaticSwitch' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, StaticSwitchDefaultValue) == 0x0000D8, "Member 'FNiagaraVariableMetaData::StaticSwitchDefaultValue' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bAddedToNodeGraphDeepCopy) == 0x0000DC, "Member 'FNiagaraVariableMetaData::bAddedToNodeGraphDeepCopy' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bOutputIsPersistent) == 0x0000DD, "Member 'FNiagaraVariableMetaData::bOutputIsPersistent' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, CachedNamespacelessVariableName) == 0x0000E0, "Member 'FNiagaraVariableMetaData::CachedNamespacelessVariableName' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bCreatedInSystemEditor) == 0x0000E8, "Member 'FNiagaraVariableMetaData::bCreatedInSystemEditor' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bUseLegacyNameString) == 0x0000E9, "Member 'FNiagaraVariableMetaData::bUseLegacyNameString' has a wrong offset!");
