...
{
public:
	class UTextureRenderTarget2D*                 GarbageMatteMask;                                  // 0x0220(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMediaBundle*                           MediaBundle;                                       // 0x0228(0x0008)(Edit, ZeroConstructor, NoClear, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAutoPlay;                                         // 0x0230(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPlayWhileEditing;                                 // 0x0231(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_232[0x6];                                      // 0x0232(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UPrimitiveComponent*                    PrimitiveCmp;                                      // 0x0238(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMediaSoundComponent*                   MediaSoundCmp;                                     // 0x0240(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoClear, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               Material;                                          // 0x0248(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         PrimitiveMaterialIndex;                            // 0x0250(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMediaBundleActorBase) == 0x000260, "Wrong size on AMediaBundleActorBase");
static_assert(offsetof(AMediaBundleActorBase, GarbageMatteMask) == 0x000220, "Member 'AMediaBundleActorBase::GarbageMatteMask' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, MediaBundle) == 0x000228, "Member 'AMediaBundleActorBase::MediaBundle' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, bAutoPlay) == 0x000230, "Member 'AMediaBundleActorBase::bAutoPlay' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, bPlayWhileEditing) == 0x000231, "Member 'AMediaBundleActorBase::bPlayWhileEditing' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, PrimitiveCmp) == 0x000238, "Member 'AMediaBundleActorBase::PrimitiveCmp' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, MediaSoundCmp) == 0x000240, "Member 'AMediaBundleActorBase::MediaSoundCmp' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, Material) == 0x000248, "Member 'AMediaBundleActorBase::Material' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, PrimitiveMaterialIndex) == 0x000250, "Member 'AMediaBundleActorBase::PrimitiveMaterialIndex' has a wrong offset!");
