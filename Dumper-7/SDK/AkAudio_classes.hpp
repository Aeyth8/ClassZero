...
static_assert(sizeof(UAkAndroidInitializationSettings) == 0x0000F0, "Wrong size on UAkAndroidInitializationSettings");
...
public:
	...
	bool                                          bDynamic;                                          // 0x021C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkRoomComponent, bDynamic) == 0x00021C, "Member 'UAkRoomComponent::bDynamic' has a wrong offset!");
...
static_assert(sizeof(UAkAssetData) == 0x000068, "Wrong size on UAkAssetData");
...
static_assert(sizeof(UAkAssetDataWithMedia) == 0x000078, "Wrong size on UAkAssetDataWithMedia");
static_assert(offsetof(UAkAssetDataWithMedia, MediaList) == 0x000068, "Member 'UAkAssetDataWithMedia::MediaList' has a wrong offset!");
...
public:
	...
	TSet<TSoftObjectPtr<class UAkAudioEvent>>     LinkedAkEvents;                                    // 0x00A8(0x0050)(Edit, EditConst, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkAudioBank) == 0x000128, "Wrong size on UAkAudioBank");
...
static_assert(sizeof(UAkAssetDataSwitchContainer) == 0x000090, "Wrong size on UAkAssetDataSwitchContainer");
static_assert(offsetof(UAkAssetDataSwitchContainer, SwitchContainers) == 0x000078, "Member 'UAkAssetDataSwitchContainer::SwitchContainers' has a wrong offset!");
static_assert(offsetof(UAkAssetDataSwitchContainer, DefaultGroupValue) == 0x000088, "Member 'UAkAssetDataSwitchContainer::DefaultGroupValue' has a wrong offset!");
...
public:
	...
	TSet<class UAkAudioEvent*>                    PostedEvents;                                      // 0x00F0(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	TSet<class UAkAuxBus*>                        UserDefinedSends;                                  // 0x0140(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	TSet<class UAkTrigger*>                       PostedTriggers;                                    // 0x0190(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	TSet<class UAkGroupValue*>                    GroupValues;                                       // 0x01E0(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkAudioEventData) == 0x000258, "Wrong size on UAkAudioEventData");
static_assert(offsetof(UAkAudioEventData, MaxAttenuationRadius) == 0x000090, "Member 'UAkAudioEventData::MaxAttenuationRadius' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, IsInfinite) == 0x000094, "Member 'UAkAudioEventData::IsInfinite' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, MinimumDuration) == 0x000098, "Member 'UAkAudioEventData::MinimumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, MaximumDuration) == 0x00009C, "Member 'UAkAudioEventData::MaximumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, LocalizedMedia) == 0x0000A0, "Member 'UAkAudioEventData::LocalizedMedia' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, PostedEvents) == 0x0000F0, "Member 'UAkAudioEventData::PostedEvents' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, UserDefinedSends) == 0x000140, "Member 'UAkAudioEventData::UserDefinedSends' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, PostedTriggers) == 0x000190, "Member 'UAkAudioEventData::PostedTriggers' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, GroupValues) == 0x0001E0, "Member 'UAkAudioEventData::GroupValues' has a wrong offset!");
...
{
public:
	TMap<class FString, TSoftObjectPtr<class UAkAssetPlatformData>> LocalizedPlatformAssetDataMap;                     // 0x0050(0x0050)(Edit, EditConst, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkAudioEvent) == 0x0000E0, "Wrong size on UAkAudioEvent");
...
public:
	...
	uint8                                         EnableSpotReflectors : 1;                          // 0x0224(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         DrawFirstOrderReflections : 1;                     // 0x0264(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         DrawSecondOrderReflections : 1;                    // 0x0264(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         DrawHigherOrderReflections : 1;                    // 0x0264(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         DrawDiffraction : 1;                               // 0x0264(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         Pad_275[0x16B];                                    // 0x0275(0x016B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAkComponent, OuterRadius) == 0x000228, "Member 'UAkComponent::OuterRadius' has a wrong offset!");
static_assert(offsetof(UAkComponent, InnerRadius) == 0x00022C, "Member 'UAkComponent::InnerRadius' has a wrong offset!");
...
static_assert(sizeof(UAkAudioInputComponent) == 0x0003F0, "Wrong size on UAkAudioInputComponent");
...
{
public:
	uint8                                         Pad_120[0x398];                                    // 0x0120(0x0398)(Fixing Size After Last Property [ Dumper-7 ])
	ECheckBoxState                                CheckedState;                                      // 0x04B8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4B9[0x3];                                      // 0x04B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             CheckedStateDelegate;                              // 0x04BC(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4CC[0x4];                                      // 0x04CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FCheckBoxStyle                         WidgetStyle;                                       // 0x04D0(0x0580)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	EHorizontalAlignment                          HorizontalAlignment;                               // 0x0A50(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	FMulticastInlineDelegateProperty_             AkOnCheckStateChanged;                             // 0x0AA8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnItemDropped;                                     // 0x0AB8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPropertyDropped;                                 // 0x0AC8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_AD8[0x50];                                     // 0x0AD8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkCheckBox) == 0x000B28, "Wrong size on UAkCheckBox");
static_assert(offsetof(UAkCheckBox, CheckedState) == 0x0004B8, "Member 'UAkCheckBox::CheckedState' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, CheckedStateDelegate) == 0x0004BC, "Member 'UAkCheckBox::CheckedStateDelegate' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, WidgetStyle) == 0x0004D0, "Member 'UAkCheckBox::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, HorizontalAlignment) == 0x000A50, "Member 'UAkCheckBox::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, IsFocusable) == 0x000A51, "Member 'UAkCheckBox::IsFocusable' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, ThePropertyToControl) == 0x000A58, "Member 'UAkCheckBox::ThePropertyToControl' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, ItemToControl) == 0x000A68, "Member 'UAkCheckBox::ItemToControl' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, AkOnCheckStateChanged) == 0x000AA8, "Member 'UAkCheckBox::AkOnCheckStateChanged' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, OnItemDropped) == 0x000AB8, "Member 'UAkCheckBox::OnItemDropped' has a wrong offset!");
static_assert(offsetof(UAkCheckBox, OnPropertyDropped) == 0x000AC8, "Member 'UAkCheckBox::OnPropertyDropped' has a wrong offset!");
...
static_assert(sizeof(UDrawPortalComponent) == 0x000440, "Wrong size on UDrawPortalComponent");
...
static_assert(sizeof(UDrawRoomComponent) == 0x000440, "Wrong size on UDrawRoomComponent");
...
public:
	...
	uint8                                         bEnableDiffraction : 1;                            // 0x0288(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableDiffractionOnBoundaryEdges : 1;             // 0x0288(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	TMap<int32, float>                            SurfaceAreas;                                      // 0x02F8(0x0050)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAkHololensInitializationSettings) == 0x0000F0, "Wrong size on UAkHololensInitializationSettings");
static_assert(offsetof(UAkHololensInitializationSettings, CommonSettings) == 0x000028, "Member 'UAkHololensInitializationSettings::CommonSettings' has a wrong offset!");
static_assert(offsetof(UAkHololensInitializationSettings, CommunicationSettings) == 0x000090, "Member 'UAkHololensInitializationSettings::CommunicationSettings' has a wrong offset!");
static_assert(offsetof(UAkHololensInitializationSettings, AdvancedSettings) == 0x0000B8, "Member 'UAkHololensInitializationSettings::AdvancedSettings' has a wrong offset!");
...
static_assert(sizeof(UAkInitBankAssetData) == 0x000088, "Wrong size on UAkInitBankAssetData");
static_assert(offsetof(UAkInitBankAssetData, PluginInfos) == 0x000078, "Member 'UAkInitBankAssetData::PluginInfos' has a wrong offset!");
...
static_assert(sizeof(UAkIOSInitializationSettings) == 0x0000F8, "Wrong size on UAkIOSInitializationSettings");
...
static_assert(sizeof(UAkLinuxInitializationSettings) == 0x0000E8, "Wrong size on UAkLinuxInitializationSettings");
...
static_assert(sizeof(UAkMacInitializationSettings) == 0x0000E8, "Wrong size on UAkMacInitializationSettings");
...
public:
	...
	uint8                                         Pad_2A[0x2E];                                      // 0x002A(0x002E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkMediaAsset) == 0x000050, "Wrong size on UAkMediaAsset");
static_assert(offsetof(UAkMediaAsset, ID) == 0x000028, "Member 'UAkMediaAsset::ID' has a wrong offset!");
static_assert(offsetof(UAkMediaAsset, AutoLoad) == 0x00002C, "Member 'UAkMediaAsset::AutoLoad' has a wrong offset!");
static_assert(offsetof(UAkMediaAsset, UserData) == 0x000030, "Member 'UAkMediaAsset::UserData' has a wrong offset!");
static_assert(offsetof(UAkMediaAsset, CurrentMediaAssetData) == 0x000040, "Member 'UAkMediaAsset::CurrentMediaAssetData' has a wrong offset!");
...
static_assert(sizeof(UAkExternalMediaAsset) == 0x0000B0, "Wrong size on UAkExternalMediaAsset");
...
static_assert(sizeof(UAkPS4InitializationSettings) == 0x0000E8, "Wrong size on UAkPS4InitializationSettings");
...
static_assert(sizeof(UAkPS5InitializationSettings) == 0x0000E8, "Wrong size on UAkPS5InitializationSettings");
...
static_assert(sizeof(UAkDPXInitializationSettings) == 0x0000E8, "Wrong size on UAkDPXInitializationSettings");
...
{
public:
	uint8                                         bEnabled : 1;                                      // 0x0258(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(UAkSettings) == 0x0002B8, "Wrong size on UAkSettings");
...
static_assert(offsetof(UAkSettings, AcousticTextureParamsMap) == 0x0001D0, "Member 'UAkSettings::AcousticTextureParamsMap' has a wrong offset!");
static_assert(offsetof(UAkSettings, SplitSwitchContainerMedia) == 0x000220, "Member 'UAkSettings::SplitSwitchContainerMedia' has a wrong offset!");
static_assert(offsetof(UAkSettings, SplitMediaPerFolder) == 0x000221, "Member 'UAkSettings::SplitMediaPerFolder' has a wrong offset!");
static_assert(offsetof(UAkSettings, UseEventBasedPackaging) == 0x000222, "Member 'UAkSettings::UseEventBasedPackaging' has a wrong offset!");
static_assert(offsetof(UAkSettings, EnableAutomaticAssetSynchronization) == 0x000223, "Member 'UAkSettings::EnableAutomaticAssetSynchronization' has a wrong offset!");
static_assert(offsetof(UAkSettings, CommandletCommitMessage) == 0x000228, "Member 'UAkSettings::CommandletCommitMessage' has a wrong offset!");
static_assert(offsetof(UAkSettings, UnrealCultureToWwiseCulture) == 0x000238, "Member 'UAkSettings::UnrealCultureToWwiseCulture' has a wrong offset!");
static_assert(offsetof(UAkSettings, AskedToUseNewAssetManagement) == 0x000288, "Member 'UAkSettings::AskedToUseNewAssetManagement' has a wrong offset!");
static_assert(offsetof(UAkSettings, bEnableMultiCoreRendering) == 0x000289, "Member 'UAkSettings::bEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, MigratedEnableMultiCoreRendering) == 0x00028A, "Member 'UAkSettings::MigratedEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, FixupRedirectorsDuringMigration) == 0x00028B, "Member 'UAkSettings::FixupRedirectorsDuringMigration' has a wrong offset!");
static_assert(offsetof(UAkSettings, WwiseWindowsInstallationPath) == 0x000290, "Member 'UAkSettings::WwiseWindowsInstallationPath' has a wrong offset!");
static_assert(offsetof(UAkSettings, WwiseMacInstallationPath) == 0x0002A0, "Member 'UAkSettings::WwiseMacInstallationPath' has a wrong offset!");
...
static_assert(sizeof(UAkStadiaInitializationSettings) == 0x0000E8, "Wrong size on UAkStadiaInitializationSettings");
static_assert(offsetof(UAkStadiaInitializationSettings, CommonSettings) == 0x000028, "Member 'UAkStadiaInitializationSettings::CommonSettings' has a wrong offset!");
static_assert(offsetof(UAkStadiaInitializationSettings, CommunicationSettings) == 0x000090, "Member 'UAkStadiaInitializationSettings::CommunicationSettings' has a wrong offset!");
static_assert(offsetof(UAkStadiaInitializationSettings, AdvancedSettings) == 0x0000B8, "Member 'UAkStadiaInitializationSettings::AdvancedSettings' has a wrong offset!");
...
static_assert(sizeof(UAkQuailInitializationSettings) == 0x0000E8, "Wrong size on UAkQuailInitializationSettings");
...
static_assert(sizeof(UAkStadiaPlatformInfo) == 0x000070, "Wrong size on UAkStadiaPlatformInfo");
...
static_assert(sizeof(UAkQuailPlatformInfo) == 0x000070, "Wrong size on UAkQuailPlatformInfo");
...
{
public:
	uint8                                         bEnableSurfaceReflectors : 1;                      // 0x0210(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	uint8                                         bEnableDiffraction : 1;                            // 0x0228(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableDiffractionOnBoundaryEdges : 1;             // 0x0228(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(UAkSwitchInitializationSettings, AdvancedSettings) == 0x0000B8, "Member 'UAkSwitchInitializationSettings::AdvancedSettings' has a wrong offset!");
...
static_assert(sizeof(UAkTVOSInitializationSettings) == 0x0000F8, "Wrong size on UAkTVOSInitializationSettings");
...
static_assert(offsetof(UAkTVOSInitializationSettings, AudioSession) == 0x000090, "Member 'UAkTVOSInitializationSettings::AudioSession' has a wrong offset!");
static_assert(offsetof(UAkTVOSInitializationSettings, CommunicationSettings) == 0x0000A0, "Member 'UAkTVOSInitializationSettings::CommunicationSettings' has a wrong offset!");
static_assert(offsetof(UAkTVOSInitializationSettings, AdvancedSettings) == 0x0000C8, "Member 'UAkTVOSInitializationSettings::AdvancedSettings' has a wrong offset!");
...
static_assert(sizeof(UAkWindowsInitializationSettings) == 0x0000F0, "Wrong size on UAkWindowsInitializationSettings");
...
static_assert(sizeof(UAkWinGDKInitializationSettings) == 0x0000F0, "Wrong size on UAkWinGDKInitializationSettings");
...
static_assert(offsetof(UAkWinGDKInitializationSettings, CommunicationSettings) == 0x000090, "Member 'UAkWinGDKInitializationSettings::CommunicationSettings' has a wrong offset!");
static_assert(offsetof(UAkWinGDKInitializationSettings, AdvancedSettings) == 0x0000B8, "Member 'UAkWinGDKInitializationSettings::AdvancedSettings' has a wrong offset!");
...
static_assert(sizeof(UAkWinAnvilInitializationSettings) == 0x0000F0, "Wrong size on UAkWinAnvilInitializationSettings");
...
static_assert(sizeof(UAkXboxOneGDKInitializationSettings) == 0x0000F0, "Wrong size on UAkXboxOneGDKInitializationSettings");
...
static_assert(offsetof(UAkXboxOneGDKInitializationSettings, ApuHeapSettings) == 0x000088, "Member 'UAkXboxOneGDKInitializationSettings::ApuHeapSettings' has a wrong offset!");
static_assert(offsetof(UAkXboxOneGDKInitializationSettings, CommunicationSettings) == 0x000090, "Member 'UAkXboxOneGDKInitializationSettings::CommunicationSettings' has a wrong offset!");
static_assert(offsetof(UAkXboxOneGDKInitializationSettings, AdvancedSettings) == 0x0000B8, "Member 'UAkXboxOneGDKInitializationSettings::AdvancedSettings' has a wrong offset!");
...
static_assert(sizeof(UAkXboxOneAnvilInitializationSettings) == 0x0000F0, "Wrong size on UAkXboxOneAnvilInitializationSettings");
...
static_assert(sizeof(UAkXboxOneInitializationSettings) == 0x0000F0, "Wrong size on UAkXboxOneInitializationSettings");
...
public:
	...
	struct FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;                             // 0x0090(0x0028)(Edit, Config, NativeAccessSpecifierPublic)
	struct FAkXSXAdvancedInitializationSettings   AdvancedSettings;                                  // 0x00B8(0x0038)(Edit, Config, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkXSXInitializationSettings) == 0x0000F0, "Wrong size on UAkXSXInitializationSettings");
static_assert(offsetof(UAkXSXInitializationSettings, CommonSettings) == 0x000028, "Member 'UAkXSXInitializationSettings::CommonSettings' has a wrong offset!");
static_assert(offsetof(UAkXSXInitializationSettings, ApuHeapSettings) == 0x000088, "Member 'UAkXSXInitializationSettings::ApuHeapSettings' has a wrong offset!");
static_assert(offsetof(UAkXSXInitializationSettings, CommunicationSettings) == 0x000090, "Member 'UAkXSXInitializationSettings::CommunicationSettings' has a wrong offset!");
static_assert(offsetof(UAkXSXInitializationSettings, AdvancedSettings) == 0x0000B8, "Member 'UAkXSXInitializationSettings::AdvancedSettings' has a wrong offset!");
...
static_assert(sizeof(UAkMPXInitializationSettings) == 0x0000F0, "Wrong size on UAkMPXInitializationSettings");
...
static_assert(sizeof(UMovieSceneAkTrack) == 0x000090, "Wrong size on UMovieSceneAkTrack");
static_assert(offsetof(UMovieSceneAkTrack, Sections) == 0x000078, "Member 'UMovieSceneAkTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneAkAudioEventTrack) == 0x000098, "Wrong size on UMovieSceneAkAudioEventTrack");
...
static_assert(sizeof(UMovieSceneAkAudioRTPCTrack) == 0x000098, "Wrong size on UMovieSceneAkAudioRTPCTrack");
