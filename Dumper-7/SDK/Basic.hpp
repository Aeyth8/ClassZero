...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05073420;
	constexpr int32 AppendString      = 0x01476460;
	constexpr int32 GNames            = 0x0505AC80;
	constexpr int32 GWorld            = 0x051ADAE0;
	constexpr int32 ProcessEvent      = 0x01669340;
