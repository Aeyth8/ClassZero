...
// 0x0040 (0x0040 - 0x0000)
struct alignas(0x08) FAkSurfaceProperties final
{
public:
	uint8                                         Pad_0[0x40];                                       // 0x0000(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAkSurfaceProperties) == 0x000008, "Wrong alignment on FAkSurfaceProperties");
static_assert(sizeof(FAkSurfaceProperties) == 0x000040, "Wrong size on FAkSurfaceProperties");

// ScriptStruct AkAudio.AkEdgeInfo
// 0x0028 (0x0028 - 0x0000)
struct alignas(0x04) FAkEdgeInfo final
{
public:
	uint8                                         Pad_0[0x28];                                       // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAkEdgeInfo) == 0x000004, "Wrong alignment on FAkEdgeInfo");
static_assert(sizeof(FAkEdgeInfo) == 0x000028, "Wrong size on FAkEdgeInfo");
...
static_assert(sizeof(FAkPoly) == 0x000018, "Wrong size on FAkPoly");
...
static_assert(offsetof(FAkPoly, SurfaceArea) == 0x000010, "Member 'FAkPoly::SurfaceArea' has a wrong offset!");
