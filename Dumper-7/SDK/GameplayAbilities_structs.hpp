...
static_assert(sizeof(FActiveGameplayCue) == 0x0000E8, "Wrong size on FActiveGameplayCue");
...
static_assert(offsetof(FActiveGameplayCue, bPredictivelyRemoved) == 0x0000E0, "Member 'FActiveGameplayCue::bPredictivelyRemoved' has a wrong offset!");
...
static_assert(sizeof(FGameplayCuePendingExecute) == 0x000168, "Wrong size on FGameplayCuePendingExecute");
