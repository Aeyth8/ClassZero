...
static_assert(sizeof(UMovieSceneSubSection) == 0x000160, "Wrong size on UMovieSceneSubSection");
...
static_assert(offsetof(UMovieSceneSubSection, SubSequence) == 0x000118, "Member 'UMovieSceneSubSection::SubSequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, ActorToRecord) == 0x000120, "Member 'UMovieSceneSubSection::ActorToRecord' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TargetSequenceName) == 0x000140, "Member 'UMovieSceneSubSection::TargetSequenceName' has a wrong offset!");
static_assert(offsetof(UMovieSceneSubSection, TargetPathToRecordTo) == 0x000150, "Member 'UMovieSceneSubSection::TargetPathToRecordTo' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnPlay;                                            // 0x0410(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPlayReverse;                                     // 0x0420(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStop;                                            // 0x0430(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPause;                                           // 0x0440(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFinished;                                        // 0x0450(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x000680, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, Status) == 0x000460, "Member 'UMovieSceneSequencePlayer::Status' has a wrong offset!");
...
static_assert(sizeof(UTestMovieSceneSubSection) == 0x000160, "Wrong size on UTestMovieSceneSubSection");
